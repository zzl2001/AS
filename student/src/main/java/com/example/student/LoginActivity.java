        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                /*case R.id.login_btn_cancle:                             //登录界面的注销按钮
                    ...
                    break;
                 */
                case R.id.login_text_change_pwd:                             //登录界面的换密码按钮
    ...
    public void login() {                                              //登录按钮监听事件
        if (isUserNameAndPwdValid()) {
            ...
            if(result==1){                                             //返回1说明用户名和密码均正确
                ...
                Intent intent = new Intent(LoginActivity.this,StudentListActivity.class) ;    //切换Login Activity至User Activity
                Bundle bundle = new Bundle();
                bundle.putString("referAccount",userName);
