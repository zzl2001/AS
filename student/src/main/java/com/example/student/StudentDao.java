...
public class StudentDao {
    ...
    public long addStudent(Student s) {
        ...
        values.put(TableContanst.StudentColumns.REFER_ACCOUNT, s.getReferAccount());
    ...
    public List<Map<String,Object>> getAllStudents() {
        ...
        while(cursor.moveToNext()) {
            ...
            String refer_account = cursor.getString(cursor.getColumnIndex(TableContanst.StudentColumns.REFER_ACCOUNT));
            map.put(TableContanst.StudentColumns.REFER_ACCOUNT, refer_account);
            data.add(map);
        }
        return data;
    }
    //按refer_account查询
    public Cursor findStudentByReferAccount(String referAccount){
        Cursor cursor = dbHelper.getWritableDatabase().query(TableContanst.STUDENT_TABLE,null,"refer_account=?",
                new String[]{referAccount},null,null,null,null);
        return cursor;
    }
