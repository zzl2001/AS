...
public class AddStudentActivity  extends Activity implements View.OnClickListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            dao = new StudentDao(new StudentDBHelper(this)); // 联系实体数据库
...
//                    modifyDateTime,referAccount);
            Student s = new Student(name,age,sex,likes,phoneNumber,trainDate,modifyDateTime,referAccount);
            Log.d("referAccount",s.getName()+s.getReferAccount());
            if (!isAdd) {
